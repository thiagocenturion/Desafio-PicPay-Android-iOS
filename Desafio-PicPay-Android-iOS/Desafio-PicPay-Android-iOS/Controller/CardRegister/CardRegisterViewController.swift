...
//        delegate?.cardRegisterViewController(didRegister: card)
    ...
    func setupLayout() {
        ...
        // Define os targets para quando o usuario digitar, validar se pode esconder/exibir o botão de Salvar
        ...
        btnRegister.textFieldsToSetDistanceFromKeyboard = [txtValidDate, txtCVV]
    }
