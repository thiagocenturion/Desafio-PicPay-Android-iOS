...
class Color: UIColor {
    ...
    open class var second: UIColor { return Color(red: 0.07, green: 0.78, blue: 0.44, alpha: 1) }
    ...
    open class var subPrimary: UIColor { return Color(red: 1, green: 1, blue: 1, alpha: 0.8) }
